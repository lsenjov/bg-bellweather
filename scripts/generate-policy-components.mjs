...
const effects = data.effects.map((effect) => effect.id === 29
  ? { ...effect, text: 'After Organise moves Support across a region boundary, add one acting-party Support at its destination.' }
  : effect);
