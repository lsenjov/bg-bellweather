...
<p><a href="../../assets/print/player-shields-a4.pdf">Print-ready shields PDF →</a> · <a href="player-folios.html">Public &amp; private sheets →</a> · <a href="shared-state-tokens.html#voting-reminders">Yes reminder markers →</a></p>
