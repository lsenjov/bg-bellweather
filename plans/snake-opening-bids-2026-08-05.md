...
4. **Physical rules, history, verification, and review — completed.** Archive the replaced batched low-player opening rule, update current rules, glossary, player aids, agent API, decisions, and changelog, run the full repository check, and resolve every high or medium independent-review finding.
