...
4. **Final verification and review — completed.** Run the complete repository check, inspect the changed app in the collaborative browser at desktop and mobile sizes, and obtain an independent code review. Resolve all high and medium findings before handoff.
