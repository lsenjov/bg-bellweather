...
3. [x] Update current rules, examples, glossary, design decisions, open questions, component specifications, candidate archive status, changelog, and the eighteen-card printable sheet/PDF.
4. [x] Run the complete repository check, conduct an independent code review, fix all high and medium findings plus low documentation findings, and repeat review until no high or medium issues remain.
