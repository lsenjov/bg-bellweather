...
1. [ ] Remove pass-orbit state and endings, enforce returned-Firm Pass eligibility, allow empty Collects, update Ruleset 22 state and dependent digital surfaces, and cover the behavior with focused tests.
2. [ ] Update the current rules, glossary, examples, player-aid and player-kit specifications, decisions, open questions, changelog, and playtest/API references; archive the replaced Ruleset 21 rules and folio specification.
